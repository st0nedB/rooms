...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let roomsUserDefaults = [
            ...
            "beaconMajor" : 0,
            "beaconMinors" : [ ] as [Int],
            "beaconDict" : [String:Int]() as [String:Int],
            "MQTTIP" : "192.168.1.1",
            "MQTTPort" : 1883,
            "MQTTUsername" : "admin" ,
            "MQTTPassword" : "password",
            "MQTTTopic" : "rooms/unconfigured/",
            "modelURL" : "http://localhost/rooms.mlmodel", 
            ] as [String : Any]
        UserDefaults.standard.register(defaults: roomsUserDefaults)
